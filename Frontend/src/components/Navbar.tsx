      ...
      {isOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <Link to="/" className="block px-3 py-2 text-gray-700 hover:text-[#112347]">Home</Link>
            <Link to="/about" className="block px-3 py-2 text-gray-700 hover:text-[#112347]">About</Link>
            <Link to="/services" className="block px-3 py-2 text-gray-700 hover:text-[#112347]">Services</Link>
            <Link to="/portfolio" className="block px-3 py-2 text-gray-700 hover:text-[#112347]">Portfolio</Link>
            <Link to="/blog" className="block px-3 py-2 text-gray-700 hover:text-[#112347]">Blog</Link>
            <Link
              to="/contact"
